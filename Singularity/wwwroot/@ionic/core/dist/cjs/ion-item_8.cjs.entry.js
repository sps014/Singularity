...
const index = require('./index-480c143c.js');
const helpers = require('./helpers-afaa9001.js');
const theme = require('./theme-d1c573d2.js');
const index$1 = require('./index-073c7cdc.js');
const ionicGlobal = require('./ionic-global-c1db87a5.js');
...
const Item = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f7986b5b81c4f289460bff2c452ce993b674236b', "aria-disabled": ariaDisabled, class: Object.assign(Object.assign(Object.assign({}, childStyles), labelColorStyles), theme.createColorClasses(this.color, {
                item: true,
                [mode]: true,
            ...
            })), role: inList ? 'listitem' : null }, index.h(TagType, Object.assign({ key: 'cfafac67cdb532e4bce2dd4989e1936c013396ba' }, attrs, inheritedAriaAttributes, { class: "item-native", part: "native", disabled: disabled }, clickFn), index.h("slot", { key: '68a5b8e978eed62d7d913ca006bd4bd01497cd32', name: "start" }), index.h("div", { key: '5b052cc338b00e8d40ab77cac7a139448f9b6452', class: "item-inner" }, index.h("div", { key: '7548addbe881a41ee32fd51627db230b56510760', class: "input-wrapper" }, index.h("slot", { key: 'b6f4edd5895b9f91bf060edb35666b0e7ea26ccc' })), index.h("slot", { key: 'b595e7fb96461ea2e356dbad6529531ca19705db', name: "end" }), showDetail && (index.h("ion-icon", { key: '091aa449464d530c921bd7de79bdc16fbdc14a70', icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon", "aria-hidden": "true", "flip-rtl": detailIcon === index$1.chevronForward }))), canActivate && mode === 'md' && index.h("ion-ripple-effect", { key: 'a4454f5ad15a67d5e41173d0227b77cd69776a18' }))));
    }
