...
const hardwareBackButton = require('./hardware-back-button-ddbc12ea.js');
...
const index$3 = require('./index-24fe3fe6.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-b68fa888.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-ddbc12ea.js'); });
